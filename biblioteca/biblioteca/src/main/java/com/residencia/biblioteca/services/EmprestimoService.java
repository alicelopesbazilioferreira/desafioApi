...
public class EmprestimoService {
	...
	private EmprestimoVO converteEntidadeParaVO(Emprestimo emprestimo) {
		...
		emprestimoVO.setCodigoLivro(emprestimo.getLivros().getCodigoLivro());
		emprestimoVO.setDataEmprestimo(emprestimo.getDataEmprestimo());
		emprestimoVO.setDataEntrega(emprestimo.getDataEntrega());
		emprestimoVO.setNumeroMatriculaAluno(emprestimo.getAlunos().getNumeroMatriculaAluno()); // potencial Java NullPointerException
		emprestimoVO.setNomeAluno(emprestimo.getAlunos().getNome()); // potencial Java NullPointerException
	...
	private Emprestimo converteVOParaEntidade(EmprestimoVO emprestimoVO, Integer id) {
		...
		emprestimo.setAlunos(alunosRepository.getById(emprestimoVO.getNumeroMatriculaAluno())); // potencial Java NullPointerException
		...
		emprestimo.setLivros(livrosRepository.getById(emprestimoVO.getCodigoLivro())); // potencial Java NullPointerException
